...
const Login = () => {
    ...
    const handleGoogleError = () => {
        setBackendErrors({ globalError: intl.formatMessage({ id: 'project.users.Login.error.google', defaultMessage: 'No se pudo iniciar sesión con Google' }) });
    };
                            ...
                            <>
                                <div className="d-flex align-items-center my-3">
                                    ...
                                    <span className="mx-3 small text-secondary" style={{ fontSize: '0.75rem', color: '#86868b' }}>
                                        <FormattedMessage id="project.users.Login.googleDivider" defaultMessage="o" />
                                    </span>
                                    <div className="flex-grow-1" style={{ borderTop: '1px solid #d2d2d7' }}></div>
                                </div>
